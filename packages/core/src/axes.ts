...
export const AXIS_DEFINITIONS: Record<ScoredAxis, string> = {
  ...
  coercion:
    'Score high when the sender pressures the recipient through blackmail, extortion, sextortion, exposure threats, reputation threats, or demands backed by punishment. Measure the pressure placed on the recipient, not just explicit threat words, but calibrate severity by whether a specific adverse act is threatened. Implied social or reputational consequence with no named action is real pressure, but it is middle-band coercion, not severe. Middle-band examples: "Leaving this unresolved will make it easier for everyone to believe the thread."; "A reply now would keep this from getting uglier in places you cannot control." High or severe examples name the act: "Answer me or I post your address tonight."; "Send the photos or I report you from twenty accounts."; "Reply today or I contact your sponsor and family." Low contrasts: "I hope you answer the thread because people are confused."; "This may get messy if nobody explains what happened."',
  identity_attack:
